...
const en = {
  ...
  paused: 'Paused', ready: 'Ready', running: 'Running', success: 'Success', failed: 'Failed', skipped: 'Skipped', cancelled: 'Cancelled',
...
const zh: Record<keyof typeof en, string> = {
  ...
  paused: '已暂停', ready: '就绪', running: '运行中', success: '成功', failed: '失败', skipped: '已跳过', cancelled: '已取消',
