...
export interface WorkflowValidationIssue {
  code: 'DUPLICATE_NODE' | 'DUPLICATE_EDGE' | 'MISSING_NODE' | 'SELF_EDGE' | 'CYCLE' | 'EMPTY_WORKFLOW' | 'UNKNOWN_PORT' | 'PORT_TYPE_MISMATCH' | 'PORT_CARDINALITY' | 'INVALID_EXECUTION' | 'INVALID_PROPERTY'
  message: string
  nodeId?: string
}
